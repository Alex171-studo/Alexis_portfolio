# Ce script exploite la vulnérabilité d'une application à mélanger la signature symétrique et asymétrique
# pour forger un token JWT. Il utilise donc une clé publique pour signer le token.
